...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-5e33a56b');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-5e33a56b');}
...
function clearFlash(){dieView.classList.remove('rl-win-5e33a56b');dieView.classList.remove('rl-lose-5e33a56b');if(frameEl){frameEl.classList.remove('rl-win-5e33a56b');frameEl.classList.remove('rl-lose-5e33a56b');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-5e33a56b');if(frameEl){frameEl.classList.add('rl-win-5e33a56b');}}else{dieView.classList.add('rl-lose-5e33a56b');if(frameEl){frameEl.classList.add('rl-lose-5e33a56b');}}
...
var brandEl=document.querySelector('.rl-brand-5e33a56b');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
